...
if("TRUE" STREQUAL "TRUE")
  set(pointcloud_to_laserscan_SOURCE_PREFIX /workspace/src/WK/G1Nav2D/src/pointcloud_to_laserscan)
  set(pointcloud_to_laserscan_DEVEL_PREFIX /workspace/devel)
  ...
  set(pointcloud_to_laserscan_INSTALL_PREFIX /workspace/install)
...
if(NOT "/workspace/src/WK/G1Nav2D/src/pointcloud_to_laserscan/include " STREQUAL " ")
  set(pointcloud_to_laserscan_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/src/WK/G1Nav2D/src/pointcloud_to_laserscan/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pointcloud_to_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/src/WK/G1Nav2D/src/pointcloud_to_laserscan/${idir}'.  ${_report}")
    endif()
