...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/WK/G1Nav2D/src/pointcloud_to_laserscan/include".split(';') if "/workspace/src/WK/G1Nav2D/src/pointcloud_to_laserscan/include" != "" else []
